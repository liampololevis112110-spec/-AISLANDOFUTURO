...
<main>
    ...
    <section id="productos" class="clearfix">
        ...
        <div class="producto-detalle clearfix">
            ...
            <p>
                <strong>Precio:</strong> $9.000 + IVA por kilogramo.<br>
    ...
    <section id="contacto">
        ...
        <form id="contactForm" onsubmit="return validarFormulario()" style="max-width:650px; margin: 40px auto 0;">
            ...
            <label for="email" style="margin-top: 20px;">Correo electrónico</label>
            <input type="email" id="email" name="email" required placeholder="ejemplo@correo.com" />

            <label for="telefono" style="margin-top: 20px;">Teléfono (opcional)</label>
            <input type="tel" id="telefono" name="telefono" placeholder="+56 9 1234 5678" />

            <label for="mensaje" style="margin-top: 20px;">Mensaje</label>
            <textarea id="mensaje" name="mensaje" required minlength="15" rows="7" placeholder="Escribe tu consulta o comentario aquí"></textarea>
